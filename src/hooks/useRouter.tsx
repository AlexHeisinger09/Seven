...
import type { RouteKey, RouterContextType, Route } from '../types/router';
...
const createRoutes = (): Route[] => [
  ...
  },
  {
    ...
    component: () => <PlaceholderPage title="Reconocimientos" />
  },
  {
    key: 'configuracion',
    label: 'Configuración',
  ...
  },
  {
    ...
    component: Content, // Usa el componente existente por ahora
    isActive: true
  },
  {
    key: 'notificaciones',
    ...
    component: () => <PlaceholderPage title="Notificaciones" />
  }
];
...
export const RouterProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  const [currentRoute, setCurrentRoute] = useState<RouteKey>('mi-ficha');
